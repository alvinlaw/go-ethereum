...
require (
	...
	github.com/ethereum/go-ethereum v1.9.25-0.20201113124315-cf856ea1ad96 // indirect
...
replace github.com/ethereum/go-ethereum => github.com/alvinlaw/go-ethereum v1.9.25
